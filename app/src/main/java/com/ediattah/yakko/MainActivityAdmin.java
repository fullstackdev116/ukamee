...
import com.ediattah.yakko.FragmentAdmin.ChatbotAdminFragment;
import com.ediattah.yakko.FragmentAdmin.FriendsAdminFragment;
import com.ediattah.yakko.FragmentAdmin.SettingsAdminFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivityAdmin.this, MessageActivity.class);
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage(getResources().getString(R.string.are_you_sure_to_logout));
        ...
        findViewById(R.id.ly_friends).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectFragment(new FriendsAdminFragment());
            }
        });
        findViewById(R.id.ly_chatbot).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectFragment(new ChatbotAdminFragment());
            }
        });
        findViewById(R.id.ly_settings).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectFragment(new SettingsAdminFragment());
            }
        });
        selectFragment(new ChatbotAdminFragment());
        setDisconnectCase();
...
//                        valueAnimator.start();
    ...
    private void showCustomPopupMenu(User user, Vcall vcall) {
        ...
        valetModeWindow.findViewById(R.id.btn_accept).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                App.goToJoinVideoCall((user.uid + MyUtils.cur_user.uid), MainActivityAdmin.this);
            }
        });
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Ok",new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog,int id) {
                ActivityCompat.finishAffinity(MainActivityAdmin.this);
                System.exit(0);
            }
        });
        builder.setNegativeButton("Cancel",new DialogInterface.OnClickListener() {
