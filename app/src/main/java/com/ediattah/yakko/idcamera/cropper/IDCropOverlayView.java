 ...
 * Desc	        ${裁剪区域布局}
 */
public class IDCropOverlayView extends View {
    ...
    private IDCropPosition cropPosition;
    ...
    public IDCropOverlayView(Context context) {
        super(context);
    }

    public IDCropOverlayView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
...
//        drawGrid(canvas);//裁剪框内部线条
    ...
    public void crop(IDCropListener cropListener, boolean needStretch) {
